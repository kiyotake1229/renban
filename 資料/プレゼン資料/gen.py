...
stats = ''.join('<div style="background:#242131;border-radius:8px;padding:10px;text-align:center"><b class="fd" style="display:block;font-size:26px;font-weight:800">%s</b><span style="font-size:12px;color:#B9B3CC">%s</span></div>' % (v, l) for v, l in [('5', '今年の参戦'), ('¥75,100', '記録した費用'), ('GH', 'いちばん行った推し')])
